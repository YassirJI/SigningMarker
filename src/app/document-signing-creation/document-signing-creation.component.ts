  ...
  onDrop(draggEvent:DragEvent):void{
   ...
   addDraggedItemToDropZone2(jThis : any, element : any, draggEvent:DragEvent) : void {
       ...
       if (element.hasClass("signature-tool")) {
          newElement =  $("<div draggable class='signerTag signHereTag draggable' recipientId='0'  order='0' tagtype='signHere' tagcolor='tagTopYellow' style='position: absolute; left:" + offsetXPos + "px; top:" + offsetYPos + "px;background-color: antiquewhite;cursor: move; border: 1px solid #BEBEBE; margin: 0 5px 10px 0;' clonedtag='yes' id='dragTagDiv'><div style=' background-image:url(../../assets/signature_placeholder.png);background-repeat:no-repeat;background-position:center;background-size: contain;height:26px;width:146px;'></div><div style=' background-image:url(../../assets/signature_placeholder.png);background-repeat:no-repeat;background-position:center;background-size: contain;height:26px;width:146px;'></div></div>");
       }
       else if (element.hasClass("text-tool")) {
          newElement = $("<div draggable class='signerTag nameHereTag draggable' recipientId='0'  order='0' tagtype='text' tagcolor='tagTopYellow' style='position: absolute; left:" + offsetXPos + "px; top:" + offsetYPos + "px; background-image:url(../../assets/signature_placeholder.png);background-repeat:no-repeat;background-position:center;background-size: contain;height:26px;width:146px;background-color: antiquewhite;cursor: move; border: 1px solid #BEBEBE; margin: 0 5px 10px 0;' clonedtag='yes' id='dragTagDiv'></div>");
       }
       else if (element.hasClass("date-tool")) {
          newElement =  $("<div draggable class='signerTag nameHereTag draggable' recipientId='0'  order='0' tagtype='dateSigned' tagcolor='tagTopYellow' style='position: absolute; left:" + offsetXPos + "px; top:" + offsetYPos + "px;background-image:url(../../assets/signature_placeholder.png);background-repeat:no-repeat;background-position:center;background-size: contain;height:26px;width:146px;background-color: antiquewhite;cursor: move; border: 1px solid #BEBEBE; margin: 0 5px 10px 0;' clonedtag='yes' id='dragTagDiv'></div>");
       }
